    ...
    public static getPrompts() : Prompt[] {
        return [
            ...
            },
            {
                ...
                getPromptPrefixMessages: () => [
                    {'role': 'user', 'content': `
                    I want you to correct spelling when asked by me. You take the input and auto correct it. Just reply to user input with correct spelling, DO NOT reply the context of the question of the user input. If the user input is correct, just inform user about the same. Sample of the conversation will show below:
